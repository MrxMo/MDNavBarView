package com.mrmo.mnavbarviewlib.adapter;
...
import com.mrmo.mnavbarviewlib.R;
 ...
 */
public class MNavBarSortAdapter extends MBaseAdapter {

    public MNavBarSortAdapter(Context context, List list) {
        super(context, list);
    }
